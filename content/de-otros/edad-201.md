...
title = "Edad"
slug = "edad-201"
date = 2008-08-24 22:03:03
description = "¿Qué se puede hacer en ochenta años? Probablemente, empezar a darse cuenta de cómo habría de vivir y cuáles son las tres o cuatro cosas que valen la pena. Un programa…"
authors = [
    "Ernesto Sábato",
]
tags = []
...
{% postscript() %}
Fragmento de *Uno y el Universo*, de 1945. Fue el primer libro publicado de [Sábato](http://es.wikipedia.org/wiki/Ernesto_Sabato), teniendo él 34 años.
{% end %}

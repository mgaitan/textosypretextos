+++
title = "Obdulio Varela, El reposo del centrojás"
slug = "obdulio-varela-el-reposo-del"
date = 2008-07-03 16:40:10
description = "Historia de vida , tal como se la conocía en el suplemento cultural de La Opinión, era una de las formas más difíciles del reportaje. Consistía en escuchar, ante un…"
draft = false
...
hero_alt = ""
comment_count = 1
legacy_url = "/de-otros/obdulio-varela-el-reposo-del/"
surtitle = ""
...
author_links = [
    { name = "Osvaldo Soriano", path = "/autores/osvaldo-soriano/" },
]
tag_links = [
...
anchor = "comment-7266"
author = "Maggie"
date = "2009-06-12 20:58:59"
date_display = "12.06.2009"
depth = 0
url_site = ""
title = "Obdulio Varela, El reposo del centrojás"
body = "Obdulio Varela fue un grande, ya no hay más jugadores que luchen por la camiseta.\n Que se puede decir de otro grande, como lo fue Osvaldo, ese que al partir, nos dejo un inmenso vacio.\n \n Que diría hoy, al ver esos millonarios de pantalones cortos que solo hacen sus grandes negocios, que fungen de selección, solo vienen a ver su familia gratis y mostrar los hijos, que para eso no los contratan.\n  Además, sin técnico, sin escuela, sin ética ni moral, solo negocios.\n Hace un bien enorme recordar estás cosas, ojala los jovenes pudieran enterarse gracias"
+++

El 16 de julio de 1950, en el estadio Maracaná de Río de Janeiro, nació una de las últimas leyendas del fútbol rioplatense; ese día, el imponente centromedio uruguayo Obdulio Varela silenció a 150 mil fanáticos que festejaban el gol brasileño en la final de la Copa del Mundo, convertido por el puntero Friaca. A los seis minutos del segundo tiempo, Brasil abrió el marcador alentado por las repletas tribunas del Maracaná, inaugurado especialmente para ese torneo. Entonces, todo Río de Janeiro fue una explosión de júbilo; los petardos y las luces de colores se encendieron de una sola vez. Obdulio, un morocho tallado sobre piedra, fue hacia su arco vencido, levantó la pelota en silencio y la guardó entre el brazo derecho y el cuerpo. Los brasileños ardían de júbilo y pedían más goles. Ese modesto equipo uruguayo, aunque temible, era una buena presa para festejar un título mundial. Tal vez el único que supo comprender el dramatismo de ese instante, de computarlo fríamente, fue el gran Obdulio, capitán--y mucho más--de ese equipo joven que empezaba a desesperarse.
